...
import com.example.sneh.studentattendance.Activity.CheckinActivity;
...
public class IntimeAdapter extends RecyclerView.Adapter<IntimeAdapter.Myviewholder>
{
    List<Check>list;
    Activity context;


    public IntimeAdapter(List<Check> list, Activity context) {
        this.list = list;
    ...
    public void onBindViewHolder(Myviewholder holder,final int position)
    {
        ...
        //holder.textviewcheckin.setText(list.get(position).getClasses());
