...
public class CheckoutearlyAdapter  extends RecyclerView.Adapter<CheckoutearlyAdapter.MyviewHolder> {
    ...
    public CheckoutearlyAdapter(ArrayList<String> studentlist,ArrayList<String> studentrolllist,Context context) {
    ...
    public void count(final String datee, final String timee,final String vehtypee)
    {
        if(arrayListStudentId.size()==0)
        {
            ...
            final DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("EarlyLeave");
