...
public class LeaveReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(studentAttendance.getLang(LeaveReportActivity.this)==0)
        {
            context = LocaleManager.setNewLocale(LeaveReportActivity.this, "en");
            resources = context.getResources();
        }
        else if(studentAttendance.getLang(LeaveReportActivity.this)==1)
        {
            context = LocaleManager.setNewLocale(LeaveReportActivity.this, "el");
            resources = context.getResources();
        }
