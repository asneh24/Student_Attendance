...
import com.example.sneh.studentattendance.Adapter.CheckoutAdapter;
...
public class CheckoutfectchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outtimtfectch);
        ...
        if (studentAttendance.getLang(CheckoutfectchActivity.this) == 0) {
            context = LocaleManager.setNewLocale(CheckoutfectchActivity.this, "en");
            resources = context.getResources();
        } else if (studentAttendance.getLang(CheckoutfectchActivity.this) == 1) {
            context = LocaleManager.setNewLocale(CheckoutfectchActivity.this, "el");
            resources = context.getResources();
        }
        ...
        RecyclerView.LayoutManager layoutManager =new LinearLayoutManager( CheckoutfectchActivity.this,LinearLayoutManager.VERTICAL,false )  ;//3
                        ...
                        if(dataSnapshot1 !=null)
                        {
                            if(dataSnapshot1.getKey().equals(userid)) {
                                ...
                                for (DataSnapshot dataSnapshot2 : dataSnapshot1.getChildren()) {
                                    ...
                                    adapter = new CheckoutAdapter(arrayStudentList,arrayStudentrollnum, CheckoutfectchActivity.this);
