...
public class CheckEarlyVehicleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_early_vehicle);


        studentAttendance = (StudentAttendance) getApplication();

        if (studentAttendance.getLang(CheckEarlyVehicleActivity.this) == 0) {
            context = LocaleManager.setNewLocale(CheckEarlyVehicleActivity.this, "en");
            resources = context.getResources();
        } else if (studentAttendance.getLang(CheckEarlyVehicleActivity.this) == 1) {
            context = LocaleManager.setNewLocale(CheckEarlyVehicleActivity.this, "el");
            resources = context.getResources();
        }
        ...
        imgbus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CheckEarlyVehicleActivity.this, LeavefectchActivity.class);
