...
import com.example.sneh.studentattendance.Activity.BusReportActivity;
...
public class BusReportAdapter extends RecyclerView.Adapter<BusReportAdapter.MyviewHolder>
{
    Activity context;
    List<Check> list;

    public BusReportAdapter(Activity context, List<Check> list) {
        this.context = context;
        this.list = list;
    }

    @Override
    public BusReportAdapter.MyviewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view;
        view= LayoutInflater.from(parent.getContext()).inflate(R.layout.absentstudent,parent,false);
        return new BusReportAdapter.MyviewHolder(view);
    }

    @Override
    public void onBindViewHolder(BusReportAdapter.MyviewHolder holder, final int position)
    {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent=new Intent(context, BusReportActivity.class);
