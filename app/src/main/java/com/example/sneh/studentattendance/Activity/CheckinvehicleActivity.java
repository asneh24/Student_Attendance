...
public class CheckinvehicleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checkinvehicle);
        studentAttendance = (StudentAttendance) getApplication();

        if (studentAttendance.getLang(CheckinvehicleActivity.this) == 0) {
            context = LocaleManager.setNewLocale(CheckinvehicleActivity.this, "en");
            resources = context.getResources();
        } else if (studentAttendance.getLang(CheckinvehicleActivity.this) == 1) {
            context = LocaleManager.setNewLocale(CheckinvehicleActivity.this, "el");
            resources = context.getResources();
        }
        ...
        imgbus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CheckinvehicleActivity.this, CheckinfetchActivity.class);
