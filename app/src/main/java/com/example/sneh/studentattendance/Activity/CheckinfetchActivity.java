...
import com.example.sneh.studentattendance.Adapter.CheckinAdapter;
...
public class CheckinfetchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intimefetch);
        ...
        if (studentAttendance.getLang(CheckinfetchActivity.this) == 0) {
            context = LocaleManager.setNewLocale(CheckinfetchActivity.this, "en");
            resources = context.getResources();
        } else if (studentAttendance.getLang(CheckinfetchActivity.this) == 1) {
            context = LocaleManager.setNewLocale(CheckinfetchActivity.this, "el");
            resources = context.getResources();
        }
        ...
        if (vehtypee.equalsIgnoreCase("Bus")) {
            txtstd.setText(resources.getString(R.string.Select_Student_Who_Come_in_Bus));
        } else if (vehtypee.equalsIgnoreCase("Taxi"))
        {
            txtstd.setText(resources.getString(R.string.Select_Student_Who_Come_in_Taxi));
        }
        else
            if(vehtypee.equalsIgnoreCase("Individual"))
            {
                txtstd.setText(resources.getString(R.string.Select_Student_Who_Come_Individual));
            }
        ...
        RecyclerView.LayoutManager layoutManager =new LinearLayoutManager( CheckinfetchActivity.this,LinearLayoutManager.VERTICAL,false )  ;//3
                        ...
                        if(dataSnapshot1 !=null)
                        {
                            if(dataSnapshot1.getKey().equals(userid)) {
                                ...
                                for (DataSnapshot dataSnapshot2 : dataSnapshot1.getChildren()) {
                                    ...
                                    adapter = new CheckinAdapter(arrayStudentList,arrayStudentrollnum, CheckinfetchActivity.this);
