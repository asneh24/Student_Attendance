...
import com.example.sneh.studentattendance.Activity.TaxiReportActivity;
...
public class TaxiReportAdapter extends RecyclerView.Adapter<TaxiReportAdapter.MyviewHolder>
{
    Activity context;
    List<Check> list;

    public TaxiReportAdapter(Activity context, List<Check> list) {
        this.context = context;
        this.list = list;
    }

    @Override
    public TaxiReportAdapter.MyviewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view;
        view= LayoutInflater.from(parent.getContext()).inflate(R.layout.absentstudent,parent,false);
        return new TaxiReportAdapter.MyviewHolder(view);
    }

    @Override
    public void onBindViewHolder(TaxiReportAdapter.MyviewHolder holder, final int position)
    {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent=new Intent(context, TaxiReportActivity.class);
